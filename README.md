...
Esta propuesta interviene la web ya existente del club de socios de cine Hoyts, mejorando el flujo desde la inscripción hasta la utilización de beneficios de los socios inscritos.
Con esta nueva herramienta cine Hoyts pretende convertirse en un programa de fidelización más cercano al usuario fortaleciendo la experiencia de las personas al aportar más ventajas y beneficios.
...
Para descubrir la problemática con respecto al club de beneficios, se realizó un proceso de investigación, el que consiste en entrevistas a usuarios y trabajadores del cine, además se revisan los comentarios de redes sociales y de la app.
